...
public final class TelaDadosBinding implements ViewBinding {
  @NonNull
  private final LinearLayout rootView;

  @NonNull
  public final ListView ListViewDados;
  ...
  private TelaDadosBinding(@NonNull LinearLayout rootView, @NonNull ListView ListViewDados,
      @NonNull Button btnBuscar, @NonNull LinearLayout swipeContainer,
      @NonNull EditText txtDataFinal, @NonNull EditText txtDataInicial) {
  ...
  @NonNull
  public static TelaDadosBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static TelaDadosBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.tela_dados, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static TelaDadosBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new TelaDadosBinding((LinearLayout) rootView, ListViewDados, btnBuscar, swipeContainer,
          txtDataFinal, txtDataInicial);
    }
